...
# =============================================================================  
    ...
    pulse_width = [3, 5, 7, 1]       # Vector of time widhts in the form [prepulse read time, pulse width, postpulse reading time] [s]
    ...
    pulses_number = 1           # Number of pulses in the train
...
# =============================================================================  
    ...
    plt.close('all')
    KT6430 = Keithley4200(address = "TCPIP0::10.60.5.103::1225::SOCKET")
    KT6430.InstInit()
...
# =============================================================================  
    ...
    for cNum in range(cycles):
        try:        
            KT6430.pulseTrainRun(Plot = plotFlag)    
            KT6430.sourceOFF()            
        except:        
            KT6430.exitSave()
            KT6430.sourceOFF()
