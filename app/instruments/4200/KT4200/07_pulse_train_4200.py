...
# =============================================================================  
    ...
    sample = "TestPulseTrain"         # Sample name
    ...
    v_pulse = 0.5               # Pulse voltage [V]
    pulse_width = [0.5, 0.5, 0.5, 20]       # Vector of time widhts in the form [prepulse read time, pulse width, postpulse reading time] [s]
    ...
    pulses_number = 100           # Number of pulses in the train
...
# =============================================================================  
    ...
    KT4200.t_read_end = pulse_width[3]
...
# =============================================================================  
    ...
    for cNum in range(cycles):
        try:        
            KT4200.pulseTrainRun(Plot = plotFlag)    
            KT4200.sourceOFF()            
        except:        
            KT4200.exitSave()
            KT4200.sourceOFF()
